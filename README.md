# INSY7120 Jupyter Notebooks

This folder contains the files used for INSY 7120 - Python for Supervised Machine Learning. They are provided in [Jupyter Notebook](https://docs.jupyter.org/en/latest/) format (`.ipynb` files) for use on [Google Colab](https://colab.google/).
...
This work is licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International license (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/). Original content by Danny J. O'Leary ([dan.oleary@auburn.edu](mailto:djo0008@auburn.edu)). You can find a copy of the full text of the license here: [LICENSE](LICENSE).
